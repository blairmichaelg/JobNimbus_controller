...
$logFile = "$repo\logs\srv_worker.log"
...
function Invoke-LogRotation {
    ...
    $oldLogs = Get-ChildItem -Path "$repo\logs" -Filter "srv_worker.log.*.old" -ErrorAction SilentlyContinue | Sort-Object CreationTime -Descending
